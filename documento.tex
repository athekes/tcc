...
\ies{Federal University of Ceará}
\iessigla{UFC}
\centro{Center of Xxxxxxxx}
\departamento{Department of Xxxxxxxxx}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%        Informacao para TCC de Graduacao         %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\graduacaoem{xxxxx Engineering}
...
\begin{document}	
	...
	\input{2-textuais/resumo.tex}
	\input{2-textuais/perguntas-de-partida.tex}
	\input{2-textuais/objetivos.tex}
	\input{2-textuais/material-e-metodos.tex}
